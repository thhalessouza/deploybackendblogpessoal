...
public class UsuarioControllerTest {
	...
	public void start() throws ParseException {
		...
		usuarioAdmin = new Usuario (0L, "Administrador", "admin@gmail.com", "admin123", dataAdmin, "admin", "foto");
		...
		usuario  = new Usuario (0L, "João Antunes", "joao@gmail.com", "12345678", dataPost, "admin", "foto" );
		
		LocalDate dataPut = LocalDate.parse("1997-07-22", DateTimeFormatter.ofPattern("yyyy-MM-dd"));	
		usuarioUpdate = new Usuario (2L, "João Antunes de Souza", "joao_souza@gmail.com", "souza123", dataPut, "admin", "foto");
